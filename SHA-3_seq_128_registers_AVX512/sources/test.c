...
int main(int argc, char **argv)
{
   ...
   keccak((const uint8_t*)msgstr, inlen,md1,28);
   keccak_std((const uint8_t*)msgstr, inlen,md,28);
   ...
   keccak((const uint8_t*)msgstr, inlen,md1,32);
   keccak_std((const uint8_t*)msgstr, inlen,md,32);
   ...
   keccak((const uint8_t*)msgstr, inlen,md1,48);
   keccak_std((const uint8_t*)msgstr, inlen,md,48);
